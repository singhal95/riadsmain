        ...
        <div class='grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4'>
          <div class=''>
            ...
            <p>
              ...
              "RUPNAGAR INSTITUTE OF AUTOMOTIVE &amp; DRIVING SCHOOL"
            </p>
          </div>
          ...
          <div>
            ...
            <hr class='h-px my-8 bg-gray-200 border-2 dark:bg-gray-700'></hr>
            <p class='mb-4 flex items-center md:justify-start break-normal'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
                fill='currentColor'
              ...
              Govt. I.T.I Nangal Road Ropar, Rupnagar, Punjab -140001
            </p>
